# Original file: https://github.com/NVIDIA-NeMo/RL/blob/1f69bb0bcc244f2ac66200d1431c2a25d454a207/examples/run_sft.py
# 
...
from llm_jp.src.data_utils import get_formatted_message_log_llmjp
...
def sft_preprocessor(
    ...
    message_log = get_formatted_message_log_llmjp(
        datum_dict["messages"],
        tokenizer,
        task_data_spec,
